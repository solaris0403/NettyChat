...
import com.example.nettychat.event.ChatBaseEventImpl;
import com.example.nettychat.event.ChatMessageEventImpl;
import com.example.nettychat.event.MessageHandler;
import com.example.nettychat.event.MessageQoSEventImpl;
...
//	    	ClientCoreSDK.DEBUG = false;
			...
			IMCoreSDK.getInstance().init(this.context);
			...
			IMCoreSDK.getInstance().setChatBaseEvent(chatBaseListener);
			IMCoreSDK.getInstance().setChatMessageEvent(chatMessageListener);
			IMCoreSDK.getInstance().setMessageQoSEvent(messageQoSListener);

			IMCoreSDK.getInstance().setMessageHandler(new MessageHandler());
